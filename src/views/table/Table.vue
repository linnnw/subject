<template>
    <div id="table">
        ...
        <div class="body">
            ...
            <div class="btn">
                <el-button size="mini" type="primary" @click="dialogFormVisible = true">增加</el-button>
                <el-button size="mini" type="primary">编辑</el-button>
                <el-button size="mini" type="primary">查看</el-button>
                <el-button size="mini" type="danger" @click="deleteList">删除</el-button>
            </div>
...
<style scoped>
    ...
    .title {
        width: 100%;
        height: 40px;
        border-bottom: #737577;
        background-color: #fff;
        box-shadow: 0px 2px 2px rgba(133,133,133,.3);
    }
    .title span {
        display: block;
        color: #fff;
